...
IG_PARSE_SRH_SEGMENT(3, 4)
    ...
    // state parse_latency {
    //     hdr.latency_head.setValid();
    //     pkt.extract(hdr.latency_head);
    //     transition accept;
    // }
...
control SwitchEgressDeparser(
    ...
    apply {
        ...
        //     mirror.emit<mirror_h>(eg_md.mirror_session, {eg_md.pkt_type, eg_md.chaff_remaining});
        // }
        pkt.emit(hdr.ethernet);
        pkt.emit(hdr.ipv4);
        pkt.emit(hdr.ipv6);
